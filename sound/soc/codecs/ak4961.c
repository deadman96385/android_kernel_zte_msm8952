        ...
        struct snd_ctl_elem_value *ucontrol)
{
	...
	pr_err("[lhs] %s: mir3_1(%x),mir3_2(%x),mir3_3(%x),mir3_4(%x)",__func__, mir3_1,mir3_2,mir3_3,mir3_4);
	switch(mir3_2)
		{
		case 0:
		...
		if(howtochange==1)
			...
			snd_soc_write(codec,RUN_STATE_DATA_2,0x63);
			snd_soc_write(codec,RUN_STATE_DATA_3,0x90);
			snd_soc_write(codec,RUN_STATE_DATA_4,0x85);
			snd_soc_write(codec,RUN_STATE_DATA_5,0x38);
			snd_soc_write(codec,RUN_STATE_DATA_6,0xd0);
			snd_soc_write(codec,RUN_STATE_DATA_7,0xc5);
			snd_soc_write(codec,RUN_STATE_DATA_8,0x1d);
			snd_soc_write(codec,RUN_STATE_DATA_9,0x90);
			snd_soc_write(codec,RUN_STATE_DATA_10,0x7a);
			snd_soc_write(codec,RUN_STATE_DATA_11,0xab);
			snd_soc_write(codec,RUN_STATE_DATA_12,0xe0);
			snd_soc_write(codec,RUN_STATE_DATA_13,0x3d);
			snd_soc_write(codec,RUN_STATE_DATA_14,0x63);
			snd_soc_write(codec,RUN_STATE_DATA_15,0x90);
      snd_soc_write(codec,CRAM_RUN_EXE,0x01);
     
     	snd_soc_write(codec,RUN_STATE_DATA_LENGTH,0x04);
			snd_soc_write(codec,RUN_STATE_START_ADDR1,0x05);
			snd_soc_write(codec,RUN_STATE_START_ADDR2,0xAA);
			snd_soc_write(codec,RUN_STATE_DATA_1,0x00);
      ...
      snd_soc_write(codec,CRAM_RUN_EXE,0x01);
    	...
    	snd_soc_write(codec,RUN_STATE_DATA_LENGTH,0x00);
			snd_soc_write(codec,RUN_STATE_START_ADDR1,0x06);
			snd_soc_write(codec,RUN_STATE_START_ADDR2,0x0f);
			snd_soc_write(codec,RUN_STATE_DATA_1,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_2,0x80);
			snd_soc_write(codec,RUN_STATE_DATA_3,0x00);
			snd_soc_write(codec,CRAM_RUN_EXE,0x01);
      
      snd_soc_write(codec,RUN_STATE_DATA_LENGTH,0x00);
			snd_soc_write(codec,RUN_STATE_START_ADDR1,0x07);
			snd_soc_write(codec,RUN_STATE_START_ADDR2,0xfe);
			snd_soc_write(codec,RUN_STATE_DATA_1,0x51);
			snd_soc_write(codec,RUN_STATE_DATA_2,0x01);
			snd_soc_write(codec,RUN_STATE_DATA_3,0x50);
			snd_soc_write(codec,CRAM_RUN_EXE,0x01);
			}		
			...
			snd_soc_write(codec,RUN_STATE_START_ADDR1,0x05);
			snd_soc_write(codec,RUN_STATE_START_ADDR2,0x96);
			snd_soc_write(codec,RUN_STATE_DATA_1,0x3a);
			snd_soc_write(codec,RUN_STATE_DATA_2,0xe2);
			snd_soc_write(codec,RUN_STATE_DATA_3,0x60);
			snd_soc_write(codec,RUN_STATE_DATA_4,0x8a);
			snd_soc_write(codec,RUN_STATE_DATA_5,0x3b);
			snd_soc_write(codec,RUN_STATE_DATA_6,0x40);
			snd_soc_write(codec,RUN_STATE_DATA_7,0xc9);
			snd_soc_write(codec,RUN_STATE_DATA_8,0xd2);
			snd_soc_write(codec,RUN_STATE_DATA_9,0x70);
			snd_soc_write(codec,RUN_STATE_DATA_10,0x75);
			snd_soc_write(codec,RUN_STATE_DATA_11,0x5b);
			snd_soc_write(codec,RUN_STATE_DATA_12,0xe0);
			snd_soc_write(codec,RUN_STATE_DATA_13,0x3a);
			snd_soc_write(codec,RUN_STATE_DATA_14,0xe2);
			snd_soc_write(codec,RUN_STATE_DATA_15,0x60);
      snd_soc_write(codec,CRAM_RUN_EXE,0x01);
    	...
    	snd_soc_write(codec,RUN_STATE_DATA_LENGTH,0x00);
			...
			snd_soc_write(codec,RUN_STATE_START_ADDR2,0x0f);
			snd_soc_write(codec,RUN_STATE_DATA_1,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_2,0x8f);
			snd_soc_write(codec,RUN_STATE_DATA_3,0xa0);
			snd_soc_write(codec,CRAM_RUN_EXE,0x01);
      ...
      snd_soc_write(codec,RUN_STATE_DATA_LENGTH,0x00);
			...
			snd_soc_write(codec,RUN_STATE_START_ADDR2,0xfe);
			snd_soc_write(codec,RUN_STATE_DATA_1,0x51);
			snd_soc_write(codec,RUN_STATE_DATA_2,0x10);
			snd_soc_write(codec,RUN_STATE_DATA_3,0x20);
			snd_soc_write(codec,CRAM_RUN_EXE,0x01);
			}		
		break;
		case 1:
      ...
      snd_soc_write(codec,CRAM_RUN_EXE,0x01);
     	...
     	snd_soc_write(codec,RUN_STATE_DATA_LENGTH,0x09);
			snd_soc_write(codec,RUN_STATE_START_ADDR1,0x05);
			snd_soc_write(codec,RUN_STATE_START_ADDR2,0xA5);
			snd_soc_write(codec,RUN_STATE_DATA_1,0x36);
			snd_soc_write(codec,RUN_STATE_DATA_2,0x95);
			snd_soc_write(codec,RUN_STATE_DATA_3,0x30);
			snd_soc_write(codec,RUN_STATE_DATA_4,0x85);
			snd_soc_write(codec,RUN_STATE_DATA_5,0xf4);
			snd_soc_write(codec,RUN_STATE_DATA_6,0x20);
			snd_soc_write(codec,RUN_STATE_DATA_7,0xc5);
			snd_soc_write(codec,RUN_STATE_DATA_8,0x5c);
			snd_soc_write(codec,RUN_STATE_DATA_9,0xf0);
			snd_soc_write(codec,RUN_STATE_DATA_10,0x7a);
			snd_soc_write(codec,RUN_STATE_DATA_11,0x0b);
			snd_soc_write(codec,RUN_STATE_DATA_12,0xe0);
			snd_soc_write(codec,RUN_STATE_DATA_13,0x44);
			snd_soc_write(codec,RUN_STATE_DATA_14,0x0d);
			snd_soc_write(codec,RUN_STATE_DATA_15,0xe0);
			snd_soc_write(codec,RUN_STATE_DATA_16,0x19);
			snd_soc_write(codec,RUN_STATE_DATA_17,0xc2);
			snd_soc_write(codec,RUN_STATE_DATA_18,0xd0);
			snd_soc_write(codec,RUN_STATE_DATA_19,0x3d);
			snd_soc_write(codec,RUN_STATE_DATA_20,0xac);
			snd_soc_write(codec,RUN_STATE_DATA_21,0xe0);
			snd_soc_write(codec,RUN_STATE_DATA_22,0xee);
			snd_soc_write(codec,RUN_STATE_DATA_23,0xe4);
			snd_soc_write(codec,RUN_STATE_DATA_24,0x40);
			snd_soc_write(codec,RUN_STATE_DATA_25,0xc2);
			snd_soc_write(codec,RUN_STATE_DATA_26,0x53);
			snd_soc_write(codec,RUN_STATE_DATA_27,0x20);
			snd_soc_write(codec,RUN_STATE_DATA_28,0x37);
			snd_soc_write(codec,RUN_STATE_DATA_29,0x58);
			snd_soc_write(codec,RUN_STATE_DATA_30,0xf0);
      snd_soc_write(codec,CRAM_RUN_EXE,0x01);
      
     	snd_soc_write(codec,RUN_STATE_DATA_LENGTH,0x00);
			snd_soc_write(codec,RUN_STATE_START_ADDR1,0x06);
			snd_soc_write(codec,RUN_STATE_START_ADDR2,0x15);
			snd_soc_write(codec,RUN_STATE_DATA_1,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_2,0x22);
			snd_soc_write(codec,RUN_STATE_DATA_3,0x10);
      snd_soc_write(codec,CRAM_RUN_EXE,0x01);
      ...
      snd_soc_write(codec,RUN_STATE_DATA_LENGTH,0x00);
			...
			snd_soc_write(codec,RUN_STATE_DATA_1,0x51);
			snd_soc_write(codec,RUN_STATE_DATA_2,0x10);
			snd_soc_write(codec,RUN_STATE_DATA_3,0x40);
			snd_soc_write(codec,CRAM_RUN_EXE,0x01);
			}		
		else if(howtochange==0)//else W to N
			{
			...
			snd_soc_write(codec,RUN_STATE_DATA_2,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_3,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_4,0xc3);
			snd_soc_write(codec,RUN_STATE_DATA_5,0x90);
			snd_soc_write(codec,RUN_STATE_DATA_6,0x70);
			snd_soc_write(codec,RUN_STATE_DATA_7,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_8,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_9,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_10,0x38);
			snd_soc_write(codec,RUN_STATE_DATA_11,0xdf);
			snd_soc_write(codec,RUN_STATE_DATA_12,0x30);
			snd_soc_write(codec,RUN_STATE_DATA_13,0x3c);
			snd_soc_write(codec,RUN_STATE_DATA_14,0x6f);
			snd_soc_write(codec,RUN_STATE_DATA_15,0x90);
      snd_soc_write(codec,CRAM_RUN_EXE,0x01);
     	...
     	snd_soc_write(codec,RUN_STATE_DATA_LENGTH,0x09);
			...
			snd_soc_write(codec,RUN_STATE_DATA_14,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_15,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_16,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_17,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_18,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_19,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_20,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_21,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_22,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_23,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_24,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_25,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_26,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_27,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_28,0x40);
			snd_soc_write(codec,RUN_STATE_DATA_29,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_30,0x00);
      snd_soc_write(codec,CRAM_RUN_EXE,0x01);
     	...
     	snd_soc_write(codec,RUN_STATE_DATA_LENGTH,0x00);
			...
			snd_soc_write(codec,RUN_STATE_START_ADDR2,0x15);
			snd_soc_write(codec,RUN_STATE_DATA_1,0x00);
			snd_soc_write(codec,RUN_STATE_DATA_2,0x3c);
			snd_soc_write(codec,RUN_STATE_DATA_3,0x90);
			snd_soc_write(codec,CRAM_RUN_EXE,0x01);
